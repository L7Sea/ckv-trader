...
const THOAI: Record<GreetingStyle, Record<Nhom, string[]>> = {
  ...
  troll: {
    ...
    tuHao:    ['Em nhớ hết các mã VN50, anh thì nhớ được bao nhiêu mã nè?', 'Nể 150 thuật toán của em chưa? Không khen là em dỗi đó!'],
  ...
  pro: {
    ...
    lamViec:  ['Đang phân tích danh mục VN50 theo 150 mô hình định lượng.', 'Nhật ký giao dịch đã được đồng bộ chuẩn T+2.5.'],
  ...
  gen_z: {
    ...
    tuHao:    ['Capy cân hết 150 thuật toán định lượng, đỉnh nóc kịch trần bay phấp phới!'],
